...
describe 'Usuário remove um galpão' do
  ...
  it 'e não apaga outros galpões' do
  	...
  	first_warehouse = Warehouse.create!(name: 'Belo Horizonte', code: 'BHZ',area: 20000, cep: '46000-000',
																	city: 'Belo Horizonte', description: 'Galpão cargas mineiras', address: 'Av Tiradentes, 20')
  	# Act
  	visit root_path
  	click_on 'Cuiaba'
  	click_on 'Remover'
